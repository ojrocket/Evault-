 ...
 * Γòæ                         EVAULT BANKING PORTAL (GUI)                      Γòæ
 * Γòæ                      Secure Banking Application                          Γòæ
 * Γòæ                                                                          Γòæ
 * Γòæ  Features: Account Creation, Login, Deposit, Withdraw, Transfer          Γòæ
 * Γòæ  Tech Stack: C++, Win32 API, SQLite                                      Γòæ
